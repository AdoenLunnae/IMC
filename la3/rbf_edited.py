...
@click.option('--test_file', '-T', default="", required=False,
              help=u'Name of the file with test data(if not present, train data will be used)')
@click.option('--classification', '-c', is_flag=True, default=False,
              show_default=True, help=u'Classification problem')
@click.option('--ratio_rbf', '-r', default=0.1, required=False, show_default=True,
              help=u'Ratio of RBF neurons with respect to training patterns')
@click.option('--l2', '-l', is_flag=True, default=False, show_default=True,
              help=u'Use L2 regularization instead of L1')
@click.option('--eta', '-e', default=1e-2, show_default=True,
              help=u'Value for the training rate')
@click.option('-outputs', '-o', default=1, show_default=True,
              help=u'Number of outputs of the dataset')
